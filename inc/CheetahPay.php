...
class CheetahPay 
{
     ...
     */
    function __construct($privateKey, $publicKey, $endpoint = null) 
    {
        self::$privateKey = $privateKey;
        
        self::$publicKey = $publicKey;
        
        self::$endpoint = empty($endpoint) ? self::$endpoint : $endpoint;
    }
     ...
     */
    function pinDeposit($pin, $amount, $network, $oderID, $depositorsPhoneNo = null) 
    {
